...
export const landingAdminApi = {
  ...
  putSettings: (formData) => http.put(`${A}/site-settings/`, formData).then(r => r.data),
  // features
  ...
  createTeam: (formData) => http.post(`${A}/landing/team/`, formData).then(r => r.data),
  updateTeam: (id, formData) => http.put(`${A}/landing/team/${id}/`, formData).then(r => r.data),
  ...
  createLocation: (formData) => http.post(`${A}/landing/locations/`, formData).then(r => r.data),
  updateLocation: (id, formData) => http.put(`${A}/landing/locations/${id}/`, formData).then(r => r.data),
